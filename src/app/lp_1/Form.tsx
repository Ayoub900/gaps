...
export default function Form({ lp }: { lp: string }) {
    ...
    return (
        <form action={handleSubmit} className='flex z-0 text-right rounded-3xl bg-red-500/50 p-8 text-lg font-semibold w-full max-w-2xl mx-auto flex-col space-y-6'>
